    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="标题" prop="ganxiexinName">
                       <el-input v-model="ruleForm.ganxiexinName"
                                 placeholder="标题" clearable  :readonly="ro.ganxiexinName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="标题" prop="ganxiexinName">
                           <el-input v-model="ruleForm.ganxiexinName"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="内容" prop="ganxiexinContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.ganxiexinContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.ganxiexinContent" label="内容" prop="ganxiexinContent">
                            <span v-html="ruleForm.ganxiexinContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='ganxiexinName'){
                          this.ruleForm.ganxiexinName = obj[o];
                          this.ro.ganxiexinName = true;
                          continue;
                      }
                      if(o=='yonghuId'){
                      ...
                      if(o=='ganxiexinContent'){
                          this.ruleForm.ganxiexinContent = obj[o];
                          this.ro.ganxiexinContent = true;
                          continue;
                      }
                    }
                }
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`ganxiexin/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.ganxiexinCrossAddOrUpdateFlag = false;
                                        this.parent.search();
